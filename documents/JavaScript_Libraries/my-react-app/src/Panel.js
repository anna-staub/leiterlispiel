...
export default function Panel({ children }) {
    const [open, setOpen] = useState(false); // open = Variable, setOpen = damit kann der Wert der Variable geämdert werden, useState = vordefinierter Hook, false = Default-Wert der Variable 'open'
